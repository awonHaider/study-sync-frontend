...
import logInPageImage from "../../Images/LogIn/logInPageImage.png";
import signalIcon from "../../Images/LogIn/signalIcon.png";
          ...
          <div className="h-full col-span-7 lg:col-span-4 flex ">
            <div className="w-[100%] bg-white p-4 lg:p-8 rounded-xl ">
              ...
              <div className="flex gap-4">
                <p className="mb-4 text-[#666666] text-sm sm:text-base">
