  ...
  return (
    <>
      <section className="p-6">
        <h1 className=" text-2xl font-semibold mb-4">User Support Messages</h1>

        <div className="grid grid-cols-1 gap-4 bg-white rounded-lg">
          {/* Right Side */}
          <div className="col-span-5 h-[72vh] rounded-lg p-4 border">
